% Multi-agent systems are increasingly relevant in space. 
% % 
% From satellite constellation coordination to autonomous collision avoidance, engineers must design systems that can predict the actions and trajectories of other objects in space while completing mission goals. 
% % 
% While many multi-agent systems cooperate toward a common goal, as international competition creates an increasingly crowded field in space, adversarial interactions must be considered.  
% % 
...
Approaches to motion planning for these problems vary based on whether the interactions between agents are cooperative, where they share the same goal, or non-cooperative, where they have competing objectives.
The cooperative problem has been extensively studied  such as in rendezvous problems and satellite cluster design. 
...
However, the noncooperative problem, in which the agents have competing objectives, 
warrants more attention due to the increasing presence of autonomous agents with conflicting interests in space.
% The increasing presence of autonomous agents with conflicting interests warrants more atetntion 
