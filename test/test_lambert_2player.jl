...
mu = 398600.4415 * 1000 
r = 6378.0 * 1000 
kep0_P = [r + 400.0 * 1000 , 0.0, 0*pi/180, 0.0, 0.0, 0.0]
kep0_E = [r + 450.0 * 1000, 0.0, 51.6*pi/180, 0.0, 0.0, 20*pi/180]
# kep0_E = [  4.737857837443617e7
            # 0.554991429016585
            # 3.1220335744595755
            # 2.6779450445889883
            # 0.5712199203126181
...
# t = ( 0.0, 86400 ) 
t = 86400 
t, x_P = propagate_2Body(kep2cart(kep0_P, mu), t, mu, 1.0)
t, x_E = propagate_2Body(kep2cart(kep0_E, mu), t, mu, 1.0)
